...
const DanceSchedule = () => {
  ...
  return (
    <div className="flex flex-col text-main rounded-2xl py-4">
      <h1 id="cours" className="text-2xl underlineTitle w-fit">Les cours proposés</h1>
      <div className="flex flex-row flex-wrap justify-center gap-2 pt-2 text-center rounded-2xl my-6">
          ...
          >
            <div className="relative h-[20rem] overflow-hidden">
              <Image
                src={course.imageSrc}
                alt={course.title}
                className="w-full object-cover rounded-t-xl group-hover:scale-110 transition-transform duration-500"
                fill
              />
            </div>
