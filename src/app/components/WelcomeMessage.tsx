...
function WelcomeMessage () {
  ...
  return (
    <>
      ...
      <div className='grid grids-cols-2 md:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-5 md:gap-4 self-center mx-auto mt-8 md:mt-28 lg:mt-44  3xl:mt-10 pb-16 space-y-4 md:space-y-0 lg:px-24'>
