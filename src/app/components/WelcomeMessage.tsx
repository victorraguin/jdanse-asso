...
function WelcomeMessage() {
  return (
    <>
      <section className="absolute -bottom-32 w-[85%] xl:w-full md:bottom-10 xl:-bottom-10 2xl:-bottom-20 3xl:bottom-10 z-40 shadow-[#ffffff23] shadow-lg bg-black border-secondary border text-main flex flex-col max-w-6xl space-y-4 px-4 self-center items-center justify-center rounded-xl py-8 text-center">
        <p className="text-lg">
      ...
      <div className="flex flex-col md:flex-row justify-around mt-36 md:mt-28 pb-16 space-y-4 md:space-y-0">
        <div className="flex flex-col items-center justify-center">
          <Image
